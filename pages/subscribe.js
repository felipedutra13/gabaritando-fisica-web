...
const Subscribe = () => {
    ...
    return (
        <div className="bg-[#c93d33] h-screen flex xl:justify-center xl:items-center">
            <div className="xl:flex xl:flex-row relative top-10 xl:top-0">
                ...
                <div className="flex justify-center items-center">
                    <div className="w-3/5 relative top-10 xl:top-0">
                        ...
                        <h2 className="pt-10 font-leagueSpartan text-center text-[#f1eeee] text-xl xl:text-3xl">Para finalizar a sua inscrição e ter acesso a todas as aulas gratuitas do Desvendando o PISM, clique no botão abaixo e entre no Grupo de WhatsApp</h2>
